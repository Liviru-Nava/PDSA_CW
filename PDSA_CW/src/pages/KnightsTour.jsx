...
const KnightsTour = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-900 to-black flex flex-col items-center justify-center p-4">
      <Link to="/" className="absolute top-6 left-6 text-white flex items-center hover:text-purple-300">
      ...
      <h1 className="text-5xl font-bold text-center mb-8 text-white">Knight's Tour Problem</h1>
